<div class="sidebar-menu">
  ...
  <div class="menu">
    <ul id="menu" >
      ...
      <li id="menu-academico" ><a href="#"><i class="fa fa-file-text"></i><span>Usuários</span><span class="fa fa-angle-right" style="float: right"></span></a>
        <ul id="menu-academico-sub" >
            <li id="menu-academico-boletim" ><a href="login.html">Login</a></li>
          <li id="menu-academico-avaliacoes" ><a href="signup.html">Sign Up</a></li>		           
        </ul>
      </li>
       <li><a href="#"><i class="fa fa-cog"></i><span>Configurações</span><span class="fa fa-angle-right" style="float: right"></span></a>
           <ul id="menu-academico-sub" >
